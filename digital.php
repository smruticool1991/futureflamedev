...
<div class="wrap-title-page">
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            <h1 class="ui-title-page">Digital Promotion</h1>
          </div>
        </div>
      </div>
      <!-- end container--> 
            ...
            <div class="col-md-4 col-sm-6">
                <div class="pricingTable">
                    <div class="pricingTable-header">
                        <h2 class="title">Local Search Engine </h2>
                    </div>
                    <!--<span class="price-label">website</span>-->
                    <img src="assets/img/localsearch.jpg" />
                    ...
                    <a href="#" class="pricingTable-signup">Read More</a>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="pricingTable green">
                    ...
                    <!--<span class="price-label">website</span>-->
                    <img src="assets/img/socialmkt.jpg" />
